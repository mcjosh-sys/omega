...
const SettingsTab = (props: Props) => {
    ...
    const handleChangeCustomValues = (e: any) => {
        ...
        state.editor.selectedElement?.id === e.target.id && dispatch({
            type: 'UPDATE_ELEMENT',
            payload: {
                elementDetails: {
            ...
            >
                ...
                <AccordionContent className="flex flex-col gap-2 ">
                    ...
                    <div className="flex gap-4">
                        ...
                        <div>
                            <Label className="text-muted-foreground pb-2">Size</Label>
                            <Input
                                placeholder="px"
                                id="fontSize"
                                ...
                                value={(state.editor.selectedElement?.styles.fontSize as string)?.replace('px','')}
                            />
                        </div>
                    </div>
                    {/* <div>
